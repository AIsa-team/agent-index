...
result = subprocess.run(
    [
        "${PLUGIN_ROOT}/.venvs/dsa/bin/python",
        "${PLUGIN_ROOT}/skills/daily-stock-analysis/scripts/dsa_port_health.py",
    ],
...
result = subprocess.run(
    [
        "${PLUGIN_ROOT}/.venvs/dsa/bin/python",
        "${PLUGIN_ROOT}/skills/daily-stock-analysis/scripts/dsa_market_brief.py",
        "US",
    ],
...
- Scripts:    `${PLUGIN_ROOT}/skills/daily-stock-analysis/scripts/`
