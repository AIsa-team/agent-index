...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/aisa-last30days/scripts/call.py --topic "主题" [--deep]
```
...
python3 ${CLAUDE_PLUGIN_ROOT}/skills/aisa-last30days/scripts/call.py --topic "AI agent business model"

# 深度扫描：了解 "DeepSeek" 在各平台的讨论
python3 ${CLAUDE_PLUGIN_ROOT}/skills/aisa-last30days/scripts/call.py --topic "DeepSeek" --deep

# 选题灵感：看科技圈最近30天最火的话题
python3 ${CLAUDE_PLUGIN_ROOT}/skills/aisa-last30days/scripts/call.py --topic "technology trends"

# 竞品分析：某个 KOL 领域最近30天的讨论
python3 ${CLAUDE_PLUGIN_ROOT}/skills/aisa-last30days/scripts/call.py --topic "value investing 2026"
```
